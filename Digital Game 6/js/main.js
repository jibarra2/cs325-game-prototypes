...
window.onload = function() {
    ...
    function create() {
          ...
          this.ball = this.physics.add.image(400, 500, 'elements', 'ball1').setCollideWorldBounds(true).setBounce(1);
          this.ball.setData('onPaddle', true);
  
          this.paddle = this.physics.add.image(400, 550, 'elements', 'paddle1').setImmovable();
